...
import 'package:scanny/admin/adminmodel/adminmodel.dart';
...
class _AdminRegistrationScreenState extends State<AdminRegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Color(0xffb4960f9)),
          onPressed: () {
  ...
  postDetailsToFirestore() async {
    ...
    adminModel.userName = userNameEditingController.text;
